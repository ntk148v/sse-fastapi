# Server-sent Events (SSE): The Introvert's Guide to Real-time Web Updates 🙈
...
In this repo, we've built a simple soccer livescore system using FastAPI and SSE. Let's break down how it works:
